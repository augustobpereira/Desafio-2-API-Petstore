# [Desafio 2] Validar ordem de compra
...
- Atualize o arquivo ordem_de_compra_steps.py para implementar a validação da ordem de compra armazenada.
- Atualize o arquivo ordem_de_compra.py para incluir o método que realiza a requisição GET.
- Execute os testes novamente para verificar se tudo está funcionando conforme o esperado.
